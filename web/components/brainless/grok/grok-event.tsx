 ...
 */
const SILVER = "var(--pi-silver)"; // 38;5;7 — ◆ event diamonds
const FG = "var(--pi-fg-strong)";
const MUTED = "var(--pi-think-muted)";
const DIM = "var(--pi-think-dim)";
const GREEN = "var(--pi-hook-green)"; // 38;5;10 — successful hook counts
